...
class NetexNL:
    ...
    def craftJourneys(self, service:ET.Element, timetable:ET.Element, general_frame:typing.Optional[ET.Element]=None, resource:typing.Optional[ET.Element]=None, enum_list:typing.Optional[list[ET.Element]]=None, loom=True, time_table = True):
